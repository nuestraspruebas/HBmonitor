            ...
            if p[1] == 'END':
                ...
                if LASTHEARD_INC:
                   if int(float(p[9]))> 2: 
                      ...
                      f.write("<TR style=\" height: 32px;font: 10pt arial, sans-serif; background-image: linear-gradient\x28to bottom right, #d0e98d,#4e6b00\x29; color:black\"><TH>Date</TH><TH>Time</TH><TH>Slot</TH><TH>TG#</TH><TH>TG Name<TH>Callsign (DMR-Id)</TH><TH>Name</TH><TH>Dur TX (s)</TH><TH>Source ID<TH>System</TH></TR>\n")
